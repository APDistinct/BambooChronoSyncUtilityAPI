...
{
    public interface IBambooHrServiceOld
    {
    ...
    public partial class BambooHrServiceOld : IBambooHrServiceOld
    {
        private readonly ILogger<BambooHrServiceOld> _logger;
        private readonly IBambooHrAPIService _bambooService;
        public BambooHrServiceOld(IBambooHrAPIService bambooService, ILogger<BambooHrServiceOld> logger) =>
